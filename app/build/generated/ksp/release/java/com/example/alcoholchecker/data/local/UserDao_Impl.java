  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `users` (`userId`,`name`,`department`,`role`,`createdAt`) VALUES (?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(3, entity.getDepartment());
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new User(_tmpUserId,_tmpName,_tmpDepartment,_tmpRole,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
      ...
      public List<User> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _item = new User(_tmpUserId,_tmpName,_tmpDepartment,_tmpRole,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
